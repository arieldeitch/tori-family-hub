...
const base: TodayDataset = {
  ...
  tasks: [
    { id: "a", kind: "task", title: "מיני", assigneeId: "m_owner", dueAt: "2026-07-24T15:00:00.000Z", status: "open", personal: true },
    { id: "b", kind: "task", title: "פיגור", assigneeId: "m_owner", dueAt: "2026-07-23T08:00:00.000Z", status: "open" },
    { id: "c", kind: "task", title: "ללא אחראי", assigneeId: null, dueAt: null, status: "open" },
    { id: "d", kind: "task", title: "ממתין", assigneeId: "m_child", dueAt: null, status: "waiting_approval" },
    { id: "e", kind: "task", title: "מבוגרים בלבד", assigneeId: "m_owner", dueAt: null, status: "open", adultsOnly: true, personal: true },
  ],
  transports: [
    { id: "t1", kind: "transport", childId: "m_child", direction: "pickup", place: "גן", timeAt: "2026-07-24T13:00:00.000Z", responsibleId: null, status: "unassigned" },
  ],
  events: [
    { id: "ev", kind: "event", title: "אסיפה", timeAt: "2026-07-24T18:00:00.000Z" },
  ],
  followUps: [
    { id: "f1", kind: "followup", title: "בנק", externalParty: "דיסקונט", responsibleId: "m_owner", dueAt: "2026-07-24T10:00:00.000Z" },
  ],
