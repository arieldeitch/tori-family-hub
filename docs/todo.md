...
- ⚠️ **Remaining: end-to-end live sign-in verification.** The hosted pilot adult's password is not known to this environment, so the weekly view could not be exercised through the browser. Everything behind it is verified directly against the hosted API.
