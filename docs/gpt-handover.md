...
- **The next action is a hosted Supabase session:** enable the Email provider, apply WP5B then WP5C, run the chores bootstrap, verify the live flow. Everything else is done.
